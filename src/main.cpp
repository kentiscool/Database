...
int main(int argc, char **argv) {
    ...
    switch (testNum) {
        case 1:
            ...
            break;
        case 2:
            std::cout << "leaf size:" << DOUBLEARRAYLEAFSIZE << " non-leaf size:" << DOUBLEARRAYNONLEAFSIZE
                      << std::endl;
            break;
        case 3:
            std::cout << "leaf size:" << STRINGARRAYLEAFSIZE << " non-leaf size:" << STRINGARRAYNONLEAFSIZE
                      << std::endl;
            break;
    }
...
void test6() {
    ...
    printf("Test6\n");
    createRelationForward();
    std::cout << "Initialize a B+ Tree index on the integer field" << std::endl;
...
void test7() {
    ...
    // Test case #5
    checkPassFail(intScan(&index, -1000, GTE, 6000, LT), 6000)

    // Test case #7

    checkPassFail(intScan(&index, size-100, GTE, size, LT), 100)
    deleteRelation();
}
